...
const formSchema = z.object({
  email: z.email(),
  password: z.string().max(50, "Pass can't be more than 50 characters"),
});
    ...
    onSubmit: async ({ value }) => {
      await adminAuthClient.signIn.email({
        ...
        fetchOptions: {
          ...
          onError: (ctx) => {
            toast.error("Unable to login you in", {
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Hey welcome back, login to your admin account
                </p>
              </div>
              <form.Field
                name="email"
              ...
              <FieldDescription className="text-center">
                Don&apos; have account?{" "}
                <Link to={"/admin/auth/signup"}>Create account</Link>
              </FieldDescription>
            </FieldGroup>
          </form>
        </CardContent>
